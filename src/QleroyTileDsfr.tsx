...
import { QleroyTileDsfrProps, QleroyTileDsfrStylesProps } from './types';
...
const Styles = styled.div<QleroyTileDsfrStylesProps>`
        ...
        <div className="fr-tile__header">
          <div className="fr-tile__pictogram">
            <svg aria-hidden="true" className="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
              <use className="fr-artwork-decorative" href={`${hrefPictogram}#artwork-decorative`}></use>
              <use className="fr-artwork-minor" href={`${hrefPictogram}#artwork-minor`}></use>
              <use className="fr-artwork-major" href={`${hrefPictogram}#artwork-major`}></use>
            </svg>
          </div>
        </div>
      </div>
